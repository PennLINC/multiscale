...
Melted_clevel_ef$Scale<-as.ordered(repScalesVector)
...
# non linear version
nonlinMod=gamm(AvgBetweenCon~Scale+te(Age,Transmodality,k=4)+te(Age,Transmodality,by=Scale,k=4)+Sex+Motion,random=list(bblid=~1),data=Melted_clevel_ef)
