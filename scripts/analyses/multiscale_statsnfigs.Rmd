...
domnetvec<-as.character(rac[3,])
netpropvec<-as.numeric(rac[4,])

mastervecs<-cbind(tmvec,confvecupper,confveclower,scalesvec)#,domnetvec,#netpropvec)
# plot transmodality by segregation age effect - color scale
# plot transmodality 

# need to patch in k=2 and k =3
pairs(mastervecs[5:464,])
```
