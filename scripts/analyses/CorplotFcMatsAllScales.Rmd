...
```{r}
# pcor pdms
pcorkAllPDM1<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/pcorPDM1_AllEdges.csv',header=F)
pcorkAllPDM2<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/pcorPDM2_AllEdges.csv',header=F)

# PDM1 @ All edges
kAllPDM1<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/pcPDM1_AllEdges.csv',header=F)
kAllPDM2<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/pcPDM2_AllEdges.csv',header=F)
kAllPDM3<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/pcPDM3_AllEdges.csv',header=F)
kAllPDM4<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/pcPDM4_AllEdges.csv',header=F)
kAllPDM5<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/pcPDM5_AllEdges.csv',header=F)
kAllPDM6<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/pcPDM6_AllEdges.csv',header=F)
kAllPDM7<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/pcPDM7_AllEdges.csv',header=F)
kAllPDM8<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/pcPDM8_AllEdges.csv',header=F)
...
# PDM1 @ K=7
# @ K=20
k7PDM1<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/PDM1_7.csv',header=F)
k7PDM2<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/PDM2_7.csv',header=F)
...
k20_svdOutput<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/edges_PCvals.csv',header=F)
...
k20_svdOutput_subjs<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/subj_PCvals.csv',header=F)
```

```{r}
# @ K=20
k20PDM1<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/PDM1_K20.csv',header=F)
k20PDM2<-read.csv('/cbica/projects/pinesParcels/multiscale/scripts/highDim_mediation/PDM2_K20.csv',header=F)
