---
title: "multiscale_statsnfigs_noneg"
author: "Adam"
date: "7/25/2020"
...
#fc<-vroom('/cbica/projects/pinesParcels/results/aggregated_data/fc/master_fcfeats_noneg.csv')
...
#write.csv(fc,'/cbica/projects/pinesParcels/results/aggregated_data/fc/master_fcfeats_rounded_noneg.csv')

### it's rounded now bb
fc<-vroom('/cbica/projects/pinesParcels/results/aggregated_data/fc/master_fcfeats_rounded_noneg.csv')
...
ggplot(LongAgeSpan_plotdf2,aes(agespans,tmvec,color=derivs,group=CIgroupingInd)) +geom_line(size=5,alpha=.3) +labs(title='Network Segregation Effect Manifestation', x = 'Age', y = 'Transmodality') +theme_classic(base_size = 28)+ xlim(c(8,23))+ scale_colour_gradientn(colours=c('green','blue','white','red','yellow'),values = c(0,.53,.58,.65,1),name="Change Per Year")
