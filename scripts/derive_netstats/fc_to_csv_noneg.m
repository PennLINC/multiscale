...
ind_file=load('/cbica/projects/pinesParcels/results/aggregated_data/ind_conmats_allscales_allsubjs_noneg.mat');
gro_file=load('/cbica/projects/pinesParcels/results/aggregated_data/gro_conmats_allscales_allsubjs_noneg.mat');	
bts_file=load('/cbica/projects/pinesParcels/results/aggregated_data/bts_conmats_allscales_allsubjs_noneg.mat');
...
writetable(cell2table(df),strcat(outdir,'/master_fcfeats_noneg.csv'));
