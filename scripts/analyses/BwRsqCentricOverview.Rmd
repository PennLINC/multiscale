...
avgbw_age_tm_sig<-ggplot(bwdf,aes(tmvec,bwAgeCorVecs.avg_bw,color=domnetvecSig)) + geom_point(size=6,alpha=.8)+ scale_color_manual(values=c('#3281ab','#670068','#007500','#b61ad0','#b8cf86','#d77d00','#c1253c','gray80')) + xlab("Transmodality") + ylab(expression(paste('Age Effect(',Delta,R^2[adj],')',sep=''))) +theme_classic(base_size = 28) +guides(color=guide_legend(title="Maximal Y7 Overlap"))+theme(legend.position="top")
```
...
ggplot(LongAgeSpan_plotdf3,aes(Age,Splines,color=Transmodality,group=Grouping)) +geom_line(size=3,alpha=.4) +labs(x = 'Age', y = 'Between-Community Coupling') +theme_classic(base_size = 28)+ xlim(c(8,23))+ scale_colour_viridis(option="inferno",guide=guide_colorbar(barwidth = 22))+theme(legend.position="top")
