...
#### attempt and trendlines in corrplot

# Change each col and row to a factor (scale3_net3 is a factor, scale3_net4)
factors<-464
...
#for(k factors
  ...
  # array for 200 gam values for each scaleindivind value (gammarray)
  gamma_ray<-array(0,c(200,length(scaleindivind)))
  # for i in scaleindivind
  gamma_ray[,i]<-
# ggplot needs to call all from same scale to construct pseudo-corplot
# margins=FALSE
# Age in Viridis
# Seg in cividis
# row of net-wise segreg beneath
