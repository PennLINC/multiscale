...
palette(colorRampPalette(c("yellow","black"))(464))
...
library(plot3Drgl)
library(rgl)
#plot3d(x=bwR2EFdf$tmvec,y=bwR2EFdf$occvec,z=bwR2EFdf$BW_R2VecEst,colvar=bwR2EFdf$scalesvec,col=viridis(29),size = 10)
```
...
## merged vectors
BwAgeCorTMDifDf<-data.frame(tmdifvec,ageEfvec,noAge_EFEfVec,EFEfvec,scalevec,Net1Vec,Net2Vec,Net1Vec17,Net2Vec17,fdr_ageEfPvec,fdr_EFEfPvec,fdr_noAge_EFEfPVec,ageDR2vec)
# fdr age dr2
