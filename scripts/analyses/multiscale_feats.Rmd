...
for (i in 2:30){
  ...
  #for (s in 1:30){
    ...
    # sample each scale according to how many times it appears in scalesSamp
  #}
    
  #  scalesSamp<-sample(featDf$corresp_scalesvec,replace=F,size=)
    # sample from featVec wtihout replacement until scalesvec is gone 
