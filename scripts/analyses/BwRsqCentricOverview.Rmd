...
# select scales
long_affilsUnique_selectScales<-long_affilsUnique[long_affilsUnique$Scale %in% c(4,7,13,20),]
...
long_affilsUnique_selectScalesCoarse<-long_affilsUnique[long_affilsUnique$Scale %in% c(2,3,4,5,6,7),]

ggplot(long_affilsUnique_selectScalesCoarse,
       aes(x = Scale, stratum = CommunityReorder, alluvium = Vertex,
           #y = Transmodality,
           fill = Yeo7, label = CommunityReorder)) +
  xlab("Number of Communities") +
  ...
  #scale_alpha_binned(range=c(.3,.9))+
  theme_classic(base_size = 30)+
  scale_fill_manual(name="Yeo7 Equivalent", values=c('#007500','#c1253c','#d77d00','#3281ab','#b61ad0','#670068'))+ theme(legend.position = "bottom")
  #scale_fill_manual(values=c('#dc8303','#8d2049','#596a85','#2d9a3d','#007938','#d9e200','#bc0943','#2b1f67','#48593a','#91a967','#4183a8','#00bb89','#3245a3','#9e3ca2','#eb75b3','#68126f','#d1001c'))
# formnat from recon error plot for matching
# FOR FIGURE 1
#ggplot(data=mcrecnerrdf,aes(y=mreconerr,x=community_vec))+geom_step(size=3,color='#262228')+geom_point(aes(y=mreconerr,x=community_vec,alpha=select),size=9) +scale_alpha(range=c(0,1))+ scale_x_continuous(name ="Number of Communitites",  breaks=seq(2,30,4))+labs(y='Reconstruction Error (a.u.)')+theme_classic(base_size = 30)+ theme(axis.title.y.left =  element_text(color = '#262228'),legend.position = 'none')
```
