...
col_fun=function(x) ifelse(abs(x)<.001,"#00000000",
...
chordDiagramFromDataFrame(chordDf,grid.col = grid.col_y17, col = col_fun)
  title(paste('PDM1 All Negative Edges'))
```
