...
# save X - Age
write.table(masteref$Age,'/cbica/projects/pinesParcels/data/aggregated_data/X.csv',sep=',',row.names = F,col.names = F)
# save Y - EF
...
# combine indices
# same M - edges
write.table(masteref[colnames(masteref)[scaleK_bw_indivi_cols_inds]],'/cbica/projects/pinesParcels/data/aggregated_data/M.csv',sep=',',row.names = F,col.names = F)
```
