...
s
	...
	for K=2:max(Krange);
		...
		% reconstr. only
		decomp_mat=load(strcat(singparc_dir, 'SingleParcel_1by1_kequal_', num2str(K), '/Sub_', num2str(bblids(s)), '/IndividualParcel_Final_sbj1_comp', num2str(K), '_alphaS21_1_alphaL10_vxInfo1_ard0_eta0/final_UV.mat'));
		data_mat=load(strcat(singparc_dir, 'SingleParcel_1by1_kequal_', num2str(K), '/Sub_', num2str(bblids(s)), '/sbjData.mat'));
