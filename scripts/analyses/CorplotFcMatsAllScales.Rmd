...
K=13
  ...
  for(i in 1:K){
    ...
    #UNCOMMENT TO INCLUDE SEG
    segplot<-ggplot(LongAgeSpan_plotdf4,aes(Age,SegSplines)) +geom_line(size=8,color=gamcolor) +labs(title=paste('Seg. Scale',K,' Net',i,sep=''), x = 'Age') +theme_classic(base_size = 28)+ xlim(c(8,23))
    ...
    # will need to change this to input ggplot as a plot within a ggplot vector
    winplot<-ggplot(LongAgeSpan_plotdf4,aes(Age,WinSplines)) +geom_line(size=8,color=gamcolor) +labs(title=paste('Net. Win. Scale',K,' Net',i,sep=''), x = 'Age') +theme_classic(base_size = 28)+ xlim(c(8,23))
    ...
    # will need to change this to input ggplot as a plot within a ggplot vector
    bwplot<-ggplot(LongAgeSpan_plotdf4,aes(Age,BwSplines)) +geom_line(size=8,color=gamcolor) +labs(title=x, x = 'Age') +theme_classic(base_size = 28)+ xlim(c(8,23))     
