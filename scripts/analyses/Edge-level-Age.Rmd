...
#
cols<-myColorRamp(c("Blue","Red"),doubleBwAgeCorTMDifDf$ageDR2vec)
#
## change colnames for EZ plot labels
NetworkA<-doubleBwAgeCorTMDifDf$net1tmvec
NetworkB<-doubleBwAgeCorTMDifDf$net2tmvec
AgeEffect<-doubleBwAgeCorTMDifDf$ageDR2vec

# subset to replicate 2d plot in 3d


plot3d(x=NetworkA,y=NetworkB,col=cols,z=AgeEffect,ylab="Network B",xlab="Network A",zlab="Age Effect")
# pre-anim align
play3d(spin3d(axis=c(-1,0,0),rpm=5.8),duration=1)
play3d(spin3d(axis=c(0,0,1),rpm=6.8),duration=1.15)
