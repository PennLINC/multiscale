...
filename='/cbica/projects/pinesParcels/results/EffectVecs/AgeMotEFSoc'
...
allPredsFN='/cbica/projects/pinesParcels/data/aggregated_data/Predicted_Obs_Cors_Soc.csv'
np.savetxt(allPredsFN,all_preds,delimiter=",")
# mean MSE
meanMSE=np.average(mse_AI[:,0])
print("Mean Mean Squared Error (unpermuted):" + str(meanMSE))
featureweightsFN='/cbica/projects/pinesParcels/data/aggregated_data/FeatureWeights_AI_Soc.csv'
np.savetxt(featureweightsFN,mean_featureWeights_AI,delimiter=",")
# save predicted subject info
subjpredsFN='/cbica/projects/pinesParcels/data/aggregated_data/SubjPreds_AI_Soc.csv'
np.savetxt(subjpredsFN,subject_preds_AI,delimiter=",")
# save permuted predictions vector
permpredsFN='/cbica/projects/pinesParcels/data/aggregated_data/PermutPreds_AI_Soc.csv'
