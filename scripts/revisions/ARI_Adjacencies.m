...
[~, sbj_AtlasLabel_NoMedialWall_n] = max(sbj_AtlasLoading_NoMedialWall_n, [], 2);
	...
	% rest parent filepath
	parentFP_ri = [ResultantFolder '/Sub_' ID_Stri '/rest_only/IndividualParcel_Final_sbj1_comp2_alphaS21_1_alphaL10_vxInfo1_ard0_eta0'];
	% load rest mat
	mRi=load([parentFP_ri '/final_UV.mat']);
	% emoID parent filepath
	parentFP_ei = [ResultantFolder '/Sub_' ID_Stri '/emoID_only/IndividualParcel_Final_sbj1_comp2_alphaS21_1_alphaL10_vxInfo1_ard0_eta0'];
	% load emoID mat
	mEi=load([parentFP_ei '/final_UV.mat']);
	% nback parent filepath
	parentFP_ni = [ResultantFolder '/Sub_' ID_Stri '/nback_only/IndividualParcel_Final_sbj1_comp2_alphaS21_1_alphaL10_vxInfo1_ard0_eta0'];
	% load nback mat
