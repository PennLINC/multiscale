...
ggplot(skinnydf,aes(x=as.numeric(Scale),y=value))  +geom_point(size=6)+geom_smooth(method='lm',color='black',size=2)+theme_classic(base_size=40) + xlab('# of Networks') + ylab('r')+scale_x_continuous(breaks=seq(2,30,by=4))
```
