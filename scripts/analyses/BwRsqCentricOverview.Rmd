...
ggplot(long_affilsUnique,
       aes(x = Scale, stratum = CommunityReorder, alluvium = Vertex,
           #y = Transmodality,
           fill = Yeo17, label = CommunityReorder, alpha=firstInstance)) +
  geom_flow(alpha=.5) +
  geom_stratum() +
  geom_text(stat = "stratum", size = 3) +
  scale_alpha_binned(range=c(.4,.7))+
  theme(legend.position = "none") +
  ggtitle("Community Emergence over Scales")+ scale_fill_manual(values=c('#dc8303','#8d2049','#596a85','#2d9a3d','#007938','#d9e200','#bc0943','#2b1f67','#48593a','#91a967','#4183a8','#00bb89','#3245a3','#9e3ca2','#eb75b3','#68126f','#d1001c'))+theme_classic()
