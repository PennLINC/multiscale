...
ggplot(predEF_AIpermutCors,aes(x=V1))+geom_density(size=1.5)+geom_vline(xintercept = predObsCor,size=2,color='#BC3754')+theme_classic(base_size=28)+ylab('')+xlab('r')+guides(y="none")+xlim(c(-.6,.6))
