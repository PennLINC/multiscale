...
writetable(cell2table(df_trans),'/cbica/projects/pinesParcels/results/aggregated_data/fc/network_grad3_overscales.csv');
csvwrite('/cbica/projects/pinesParcels/results/aggregated_data/fc/network_grad3_overscales_forviz.csv',df_viz);
