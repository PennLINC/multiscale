...
Segreg_age_scale<-ggplot(Seg_CIplotdf[indofint,],aes(tmvec,corVecEst,color=scalesvec)) + geom_point(size=4) + xlab("Transmodality") + ylab("AgeSegregCor")+theme_classic(base_size = 28)+ ylim(-.5,.5)+ ggtitle('Correlation of Network Segregation and Age over All Networks')
