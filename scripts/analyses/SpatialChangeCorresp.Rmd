...
for (K in 2:30){
  ...
  MADx=data.frame(c(LMAD[,K],RMAD[,K]),c(L[,K],R[,K]))
  ...
  print(ggplot(MADx,aes(x=LoadingChange,y=MAD)) + geom_pointdensity(adjust=.001) + scale_color_viridis_c()+ggtitle(paste(K))+theme_classic())
