...
emergence_over_scales_anim<-agF_sc2 + transition_states(as.integer(scalesvec), state_length = 3)

anim_save('~/multiscale/emergence_over_scales_anim.gif',animation=emergence_over_scales_anim)
```
