...
# figure 5 flag
# motor by scale
ggplot(bwdf,aes(scalesvec,bwAgeCorVecs.avg_bw,color=domnetvec))+ scale_color_manual(values=c('#c1253c','#3281ab')) + xlab("# of Communities") + ylab(expression(paste('Age Effect (',Delta,R^2[adj],')'))) +theme_classic(base_size = 28) +guides(alpha=FALSE,color=guide_legend(title="Maximal Y7 Overlap"))+theme(legend.position='top')+geom_smooth(data=subset(bwdf,domnetvec=='Motor'),method='gam',formula = y~s(x,k=4))+geom_smooth(data=subset(bwdf,domnetvec=='DM'),method='gam',formula = y~s(x,k=4))
...
# figure 5 v2 flag
fig5v2<-ggplot(bwdf,aes(scalesvec,bwAgeCorVecs.avg_bw,color=domnetvec17)) + xlab("# of Communities") + ylab(expression(paste('Age Effect (',Delta,R^2[adj],')'))) +theme_classic(base_size = 28) +guides(alpha=FALSE,color=guide_legend(title="Maximal Y7 Overlap"))+theme(legend.position='top')+geom_smooth(data=subset(bwdf,domnetvec17=='Somatomotor A'),method='gam',formula = y~s(x,k=3))+geom_smooth(data=subset(bwdf,domnetvec17=='DM_B'),method='gam',formula = y~s(x,k=3))+geom_point(data=subset(bwdf,domnetvec17=='Somatomotor A'),size=3)+geom_point(data=subset(bwdf,domnetvec17=='DM_B'),size=3)
...
ggplot(DMbwdf,aes(scalesvec,bwAgeCorVecs.avg_bw,color=domnetvec))+ scale_color_manual(values=c('#c1253c','#b61ad0','#670068')) + xlab("# of Communities") + ylab(expression(paste('Age Effect (',Delta,R^2[adj],')'))) +theme_classic(base_size = 28) +guides(alpha=FALSE,color=guide_legend(title="Maximal Y7 Overlap"))+theme(legend.position='top')+geom_smooth(method='gam',formula = y~s(x,k=3))
...
ggplot(motorbwdfMed,aes(scalesvec,AB_Est,color=domnetvec)) + geom_point(size=6)+ scale_color_manual(values=c('#3281ab','#b61ad0','#670068')) + xlab("# of Communities") + ylab('AB Path Coefficient') +theme_classic(base_size = 28) +guides(alpha=FALSE,color=guide_legend(title="Maximal Y7 Overlap"))+theme(legend.position='none')+geom_smooth()

# figure 7 flag
ggplot(MediationDF,aes(scalesvec,AB_Est,color=domnetvec))+ scale_color_manual(values=c('#c1253c','#3281ab')) + xlab("# of Communities") + ylab('AB Path Coefficient') +theme_classic(base_size = 28) +guides(alpha=FALSE,color=guide_legend(title="Yeo 7 Overlap"))+theme(legend.position='top')+geom_smooth(data=subset(MediationDF,domnetvec=='Motor'),method='gam',formula = y~s(x,k=3))+geom_smooth(data=subset(MediationDF,domnetvec=='DM'),method='gam',formula = y~s(x,k=3))

gamdm<-gam(AB_Est~s(scalesvec,k=3),data=DMbwdfMed)
gammot<-gam(AB_Est~s(scalesvec,k=3),data=motorbwdfMed)


# figure 7 v2
MediationDF$domnetvec17<-domnetvec17
fig7v2<-ggplot(MediationDF,aes(scalesvec,AB_Est,color=domnetvec17)) + xlab("# of Communities") + ylab('AB Path Coefficient') +theme_classic(base_size = 28) +guides(alpha=FALSE,color=guide_legend(title="Maximal Y17 Overlap"))+theme(legend.position='top')+geom_smooth(data=subset(MediationDF,domnetvec17=='Somatomotor A'),method='gam',formula = y~s(x,k=3))+geom_smooth(data=subset(MediationDF,domnetvec17=='DM_B'),method='gam',formula = y~s(x,k=3))+geom_point(data=subset(MediationDF,domnetvec17=='Somatomotor A'),size=3)+geom_point(data=subset(MediationDF,domnetvec17=='DM_B'),size=3)
...
# figure 6 flag
raw2<-ggplot(bwR2EFdf,aes(tmvec,BW_R2VecEst,color=domnetSig)) + scale_color_manual(values=c('#007500','#c1253c','#d77d00','#b8cf86','#3281ab','#b61ad0','#670068','gray')) + xlab("Transmodality") + ylab(expression(paste(Delta,R^2[adj]))) +theme_classic(base_size = 40) + geom_point(size=7,alpha=.8,aes(tmvec,BW_R2VecEst)) +guides(alpha=FALSE,color=guide_legend(title="Maximal Y7 Overlap"))+theme(legend.position="none")

# figure 5 v2 flag
Somat_A_bwdf<-bwdf[domnetvec17=='Somatomotor A',]
DM_B_bwdf<-bwdf[domnetvec17=='DM_B',]

fig5Cv2<-ggplot(bwdf,aes(scalesvec,bwAgeCorVecs.avg_bw,color=domnetvec17)) + xlab("# of Communities") + ylab(expression(paste('Age Effect (',Delta,R^2[adj],')'))) +theme_classic(base_size = 28) +guides(alpha=FALSE,color=guide_legend(title="Maximal Y7 Overlap"))+theme(legend.position='top')+geom_smooth(data=subset(bwdf,domnetvec17=='Somatomotor A'),method='gam',formula = y~s(x,k=4))+geom_smooth(data=subset(bwdf,domnetvec17=='DM_B'))+geom_point(data=subset(bwdf,domnetvec17=='Somatomotor A'),size=3)+geom_point(data=subset(bwdf,domnetvec17=='DM_B'),size=3)

motorbwdf<-bwR2EFdf[domnetvec=='Motor',]
DMbwdf<-bwR2EFdf[domnetvec=='DM',]
gamdm<-gam(BW_R2VecEst~s(scalesvec,k=4),data=DMbwdf)
gammot<-gam(BW_R2VecEst~s(scalesvec,k=4),data=motorbwdf)
...
# figure 6 flag
ggplot(bwR2EFdf,aes(scalesvec,BW_R2VecEst,color=domnetvec))+ scale_color_manual(values=c('#c1253c','#3281ab')) + xlab("# of Communities") + ylab(expression(paste('EF Effect (',Delta,R^2[adj],')'))) +theme_classic(base_size = 28) +guides(alpha=FALSE,color=guide_legend(title="Maximal Y7 Overlap"))+theme(legend.position='top')+geom_smooth(data=subset(bwR2EFdf,domnetvec=='Motor'),method='gam',formula = y~s(x,k=4))+geom_smooth(data=subset(bwR2EFdf,domnetvec=='DM'),method='gam',formula = y~s(x,k=4))

# figure 6 v2
bwR2EFdf$domnetvec17<-domnetvec17

fig6v2<-ggplot(bwR2EFdf,aes(scalesvec,BW_R2VecEst,color=domnetvec17)) + xlab("# of Communities") + ylab(expression(paste('EF Effect (',Delta,R^2[adj],')'))) +theme_classic(base_size = 28) +guides(alpha=FALSE,color=guide_legend(title="Maximal Yeo Overlap"))+theme(legend.position='top')+geom_smooth(data=subset(bwR2EFdf,domnetvec17=='Somatomotor A'),method='gam',formula = y~s(x,k=4))+geom_smooth(data=subset(bwR2EFdf,domnetvec17=='DM_B'),method='gam',formula = y~s(x,k=4))+geom_point(data=subset(bwR2EFdf,domnetvec17=='Somatomotor A'),size=3)+geom_point(data=subset(bwR2EFdf,domnetvec17=='DM_B'),size=3)

Somat_A_bwdf<-bwR2EFdf[domnetvec17=='Somatomotor A',]
DM_B_bwdf<-bwR2EFdf[domnetvec17=='DM_B',]
gamdm_B<-gam(BW_R2VecEst~s(scalesvec,k=4),data=DM_B_bwdf)
gammot_A<-gam(BW_R2VecEst~s(scalesvec,k=4),data=Somat_A_bwdf)
...
# figure 5 flag
ggplot(BwAgeCorTMDifDf,aes(y=tmdifvec,x=scalevec))+geom_smooth()+geom_point()
cor.test(BwAgeCorTMDifDf$tmdifvec,scalevec)
```
