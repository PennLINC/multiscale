...
for s=1:length(subjs)
	% load in data
	fp=['/cbica/projects/pinesParcels/data/CombinedData/' num2str(subjs(s)) '/fc_metrics_noneg.mat']
	fcmets=load(fp);	
	pcfp=['/cbica/projects/pinesParcels/data/CombinedData/' num2str(subjs(s)) '/pc_metrics_noneg.mat']
	pcmets=load(pcfp);
	% throw it in 
	for k=2:max(Krange)
...
save('/cbica/projects/pinesParcels/results/aggregated_data/ind_conmats_allscales_allsubjs_noneg.mat','ind_mats');
save('/cbica/projects/pinesParcels/results/aggregated_data/gro_conmats_allscales_allsubjs_noneg.mat','gro_mats');
save('/cbica/projects/pinesParcels/results/aggregated_data/bts_conmats_allscales_allsubjs_noneg.mat','bTS_indmats');
% matlab needs this v7.3 for files bigger than 2gb
save('/cbica/projects/pinesParcels/results/aggregated_data/vwise_pospc_allscales_allsubjs_noneg.mat','pcoefpos','-v7.3');
save('/cbica/projects/pinesParcels/results/aggregated_data/vwise_negpc_allscales_allsubjs_noneg.mat','pcoefneg','-v7.3');
