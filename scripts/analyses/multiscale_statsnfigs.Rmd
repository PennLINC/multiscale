...
```{r}
ggplot(ind_GBwcors,aes(x=ind_GBwcors$X1,y=ind_GBwcors$X2))+geom_line()+geom_line(aes(ind_GBwcors$X1,ind_GBwcors$X3,col='red'))+xlab('Scale')+ylab('Global B/w x Age correlation')
