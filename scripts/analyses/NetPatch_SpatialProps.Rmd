...
patchTM<-ggplot(Seg_CIplotdf,aes(Tot_patchnum,tmvec,color=domnetvec,alpha=netpropvec^2,group=V7))+ geom_point(size=5,aes(Tot_patchnum,tmvec)) + scale_color_manual(values=c('#007500','#c1253c','#d77d00','#b8cf86','#3281ab','#b61ad0','#670068')) + ylab("Transmodality") + xlab("Total Patch number") +theme_classic(base_size = 28)+guides(alpha=FALSE,color=FALSE)+theme(legend.position="top",legend.title = element_blank(),axis.title.x=element_blank(), axis.text.x=element_blank(),axis.title.y=element_blank(), axis.text.y=element_blank())
...
patchAgeSeg<-ggplot(Seg_CIplotdf,aes(Tot_patchnum,corVecEst,color=domnetvec,alpha=netpropvec^2,group=V7)) + geom_point(size=5,aes(Tot_patchnum,corVecEst))+ scale_color_manual(values=c('#007500','#c1253c','#d77d00','#b8cf86','#3281ab','#b61ad0','#670068')) + xlab("Total Number of Patches") + ylab("AgeSegregCor") +theme_classic(base_size = 28)+ ylim(-.5,.5)+guides(alpha=FALSE,color=FALSE)+theme(legend.position="top",legend.title = element_blank(),axis.title.x=element_blank(), axis.text.x=element_blank(),axis.title.y=element_blank(), axis.text.y=element_blank())
...
###ggplot(Seg_CIplotdf,aes(scalesvec,Tot_patchnum, color=domnetvec,alpha=netpropvec^2,group=V7)) + geom_point(size=5,aes(scalesvec,Tot_patchnum),position="jitter")+ scale_color_manual(values=c('#007500','#c1253c','#d77d00','#b8cf86','#3281ab','#b61ad0','#670068')) + ylab("Total Number of Patches") + xlab("Scale") +theme_classic(base_size = 28)
```
...
geodAgeSeg<-ggplot(Seg_CIplotdf,aes(Patch_GeoDisperse,CIbounds,color=domnetvec,alpha=netpropvec^2,group=V7)) + scale_color_manual(values=c('#007500','#c1253c','#d77d00','#b8cf86','#3281ab','#b61ad0','#670068')) + xlab("Geodesic Dispersion") + ylab("AgeSegregCor") +theme_classic(base_size = 28) + geom_point(size=5,aes(Patch_GeoDisperse,corVecEst))+ ylim(-.5,.5)+guides(alpha=FALSE,color=FALSE)+theme(legend.position="top",legend.title = element_blank(),axis.title.x=element_blank(), axis.text.x=element_blank(),axis.title.y=element_blank(), axis.text.y=element_blank())

eucAgeSeg<-ggplot(Seg_CIplotdf,aes(Patch_EucDisperse,CIbounds,color=domnetvec,alpha=netpropvec^2,group=V7)) + scale_color_manual(values=c('#007500','#c1253c','#d77d00','#b8cf86','#3281ab','#b61ad0','#670068')) + xlab("Euclidean Dispersion") + ylab("AgeSegregCor") +theme_classic(base_size = 28) + geom_point(size=5,aes(Patch_EucDisperse,corVecEst)) + ylim(-.5,.5)+guides(alpha=FALSE,color=FALSE)+theme(legend.position="top",legend.title = element_blank(),axis.title.x=element_blank(), axis.text.x=element_blank(),axis.title.y=element_blank(), axis.text.y=element_blank())
...
geodTM<-ggplot(Seg_CIplotdf,aes(Patch_GeoDisperse,tmvec,color=domnetvec,alpha=netpropvec^2,group=V7))+ geom_point(size=5,aes(Patch_GeoDisperse,tmvec)) + scale_color_manual(values=c('#007500','#c1253c','#d77d00','#b8cf86','#3281ab','#b61ad0','#670068')) + ylab("Transmodality") + xlab("Geodesic Dispersion") +theme_classic(base_size = 28)+guides(alpha=FALSE,color=FALSE)+theme(legend.position="top",legend.title = element_blank(),axis.title.x=element_blank(), axis.text.x=element_blank(),axis.title.y=element_blank(), axis.text.y=element_blank())

eucTM<-ggplot(Seg_CIplotdf,aes(Patch_EucDisperse,tmvec,color=domnetvec,alpha=netpropvec^2,group=V7))+ geom_point(size=5,aes(Patch_EucDisperse,tmvec)) + scale_color_manual(values=c('#007500','#c1253c','#d77d00','#b8cf86','#3281ab','#b61ad0','#670068')) + ylab("Transmodality") + xlab("Euclidean Dispersion") +theme_classic(base_size = 28)+guides(alpha=FALSE,color=FALSE)+theme(legend.position="top",legend.title = element_blank(),axis.title.x=element_blank(), axis.text.x=element_blank(),axis.title.y=element_blank(), axis.text.y=element_blank())
```
...
seg_tm_dispersion<-lm(corVecEst~tmvec+Patch_GeoDisperse+Tot_patchnum,data=Seg_CIplotdf)
```
