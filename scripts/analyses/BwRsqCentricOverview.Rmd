...
BwAgeCorTMDifDf_prWeights<-data.frame(tmdifvec,ageEfvec,noAge_EFEfVec,EFEfvec,scalevec,Net1Vec,Net2Vec,Net1Vec17,Net2Vec17,fdr_ageEfPvec,fdr_EFEfPvec,fdr_noAge_EFEfPVec,as.numeric(featWeightsAD$V1),as.numeric(featWeightsAI$V1),as.numeric(featWeightsADL$V1),as.numeric(featWeightsAIL$V1))
# fix last four colnames
colnames(BwAgeCorTMDifDf_prWeights)[13:16]<-c('AgeDependentWeights','AgeIndependentWeights','AgeDependentWeights_Las','AgeIndependentWeights_Las')
#y7ver
