...
quadrantdf<-data.frame(bwAvgCon[,MU4I],bwAvgCon[,MT4I],bwAvgCon[,MU20I],bwAvgCon[,MT20I],masterdf$Age,masteref$F1_Exec_Comp_Cog_Accuracy)
colnames(quadrantdf)<-c('Unimodal4','Transmodal4','Unimodal20','Transmodal20','Age','EF')
# most unimodal
U4<-ggplot(quadrantdf,aes(x=Age,y=Unimodal4))+geom_point()+geom_smooth(method='lm')+theme_classic()+ylab('Avg. B/w Con. @ K=4, Unimodal')
T4<-ggplot(quadrantdf,aes(x=Age,y=Transmodal4))+geom_point()+geom_smooth(method='lm',color='red')+theme_classic()+ylab('Avg. B/w Con. @ K=4, Transmodal')
U20<-ggplot(quadrantdf,aes(x=Age,y=Unimodal20))+geom_point()+geom_smooth(method='lm')+theme_classic()+ylab('Avg. B/w Con. @ K=20, Unimodal')
T20<-ggplot(quadrantdf,aes(x=Age,y=Transmodal20))+geom_point()+geom_smooth(method='lm',color='red')+theme_classic()+ylab('Avg. B/w Con. @ K=20, Transmodal')

#### add motion control

ggarrange(U4,U20,T4,T20)
#### now for EF
controlledEF<-gam(EF~s(Age,k=3),data=quadrantdf)$residuals
quadrantdf$AgC_EF<-controlledEF
# most unimodal
EU4<-ggplot(quadrantdf,aes(x=AgC_EF,y=Unimodal4))+geom_point()+geom_smooth(method='lm')+theme_classic()+ylab('Avg. B/w Con. @ K=4, Unimodal')+xlab('EF')
ET4<-ggplot(quadrantdf,aes(x=AgC_EF,y=Transmodal4))+geom_point()+geom_smooth(method='lm',color='red')+theme_classic()+ylab('Avg. B/w Con. @ K=4, Transmodal')+xlab('EF')
EU20<-ggplot(quadrantdf,aes(x=AgC_EF,y=Unimodal20))+geom_point()+geom_smooth(method='lm')+theme_classic()+ylab('Avg. B/w Con. @ K=20, Unimodal')+xlab('EF')
ET20<-ggplot(quadrantdf,aes(x=AgC_EF,y=Transmodal20))+geom_point()+geom_smooth(method='lm',color='red')+theme_classic()+ylab('Avg. B/w Con. @ K=20, Transmodal')+xlab('EF')
