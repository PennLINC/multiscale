...
for i = 1:length(LeftCell)
    ...
    ResultantFile = [ResultantFolder_I 'IndividualParcel_Final_sbj1_comp' num2str(K) '_alphaS21_1_alphaL' num2str(alphaL) '_vxInfo1_ard0_eta0/final_UV.mat'];
