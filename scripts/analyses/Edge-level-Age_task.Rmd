...
for (i in 1:length(colnames(individ_scalebybw_df))){
    ...
    derv<-derivatives(AgeGam,term='s(Age)')
    derv<- derv %>%
...
bootResEdgeAge<-readRDS('/cbica/projects/pinesParcels/data/Age_EdgeLevel_Task_bootInfo_1.rds')
