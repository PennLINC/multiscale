...
concatpvecs<-c(ageEfPvec,EF_BPvec,noAge_EFEfPVec)
...
## merged vectors
BwAgeCorTMDifDf<-data.frame(tmdifvec,ageEfvec,noAge_EFEfVec,EFEfvec,scalevec,Net1Vec,Net2Vec,Net1Vec17,Net2Vec17,fdr_ageEfPvec,fdr_EFEfPvec,fdr_noAge_EFEfPVec,ageDR2vec,occdifvec,all3pgDifvec,domnetSig1,domnetSig2,domnetAgelessSig1,domnetAgelessSig2)
# fdr age dr2
...
# use calculated bwAvg Con for intercept
BW_interceptVec<-colMeans(bwAvgCon)
