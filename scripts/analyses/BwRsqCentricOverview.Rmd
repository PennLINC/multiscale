...
# gamm version
model=gamm(value~Motion+Sex+s(Scale,k=3,fx=T)+ti(Age,k=3,fx=T)+ti(transmodality,k=3,fx=T)+ti(Scale,Age,k=3,fx=T)+ti(Scale,transmodality,k=3,fx=T)+ti(Scale,Age,transmodality,k=3,fx=T),random=list(bblid=~1),data=melt_long)
#lmer version
