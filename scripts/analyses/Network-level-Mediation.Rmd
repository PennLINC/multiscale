...
mergedBootStraps<-rbind(r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,r13,r14,r15,r16,r17,r18,r19,r20)

# range of AB~Transmodality
print(range(mergedBootStraps))

# for linear - significance
CI_LIN=quantile(mergedBootStraps$AB_testStatLIN,c(0.025,0.975)) 
...
#saveRDS(savedBOOTinfo,'~/multiscale/Med_NetLevel_bootInfo.rds')
