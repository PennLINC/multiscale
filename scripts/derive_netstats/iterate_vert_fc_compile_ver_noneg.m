...
for s=2:length(subjs);
	outdir = ['/cbica/projects/pinesParcels/data/CombinedData/' num2str(subjs(s)) '/fc_metrics_noneg.mat']; 
	outdirp = ['/cbica/projects/pinesParcels/data/CombinedData/' num2str(subjs(s)) '/pc_metrics_noneg.mat'];
	...
	%if ~exist(outdir, 'file')
		...
		cmd = ['/cbica/projects/pinesParcels/multiscale/scripts/derive_netstats/run_subj_vert_fc_matlab_compile_noneg.sh $MATLAB_DIR ' configfp ];
