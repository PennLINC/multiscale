...
col_fun=function(x) ifelse(abs(x)<.05,"#00000000",
                           ifelse(x<0,"red","blue"))
...
#PDM 1
ReArAgeEfMat[1,2]<- 0.7597
ReArAgeEfMat[2,1]<- 0.7597
ReArAgeEfMat[1,3]<- 0.3849
ReArAgeEfMat[3,1]<- 0.3849
ReArAgeEfMat[1,4]<- -0.1034
ReArAgeEfMat[4,1]<- -0.1034
ReArAgeEfMat[2,3]<- 0.0054
ReArAgeEfMat[3,2]<- 0.0054
ReArAgeEfMat[2,4]<- -0.5033
ReArAgeEfMat[4,2]<- -0.5033
ReArAgeEfMat[3,4]<- 0.1027
ReArAgeEfMat[4,3]<- 0.1027

chordDiagram(ReArAgeEfMat,grid.col = grid.col, col = col_fun,symmetric = "TRUE",annotationTrack=c("name","grid"),self.link = 1)
title(paste('PDM1 at K =',K))
  
#PDM 2
ReArAgeEfMat[1,2]<- 0.1219
ReArAgeEfMat[2,1]<- 0.1219
ReArAgeEfMat[1,3]<- 0.1494
ReArAgeEfMat[3,1]<- 0.1494
ReArAgeEfMat[1,4]<- -0.1181
ReArAgeEfMat[4,1]<- -0.1181
ReArAgeEfMat[2,3]<- -0.7718
ReArAgeEfMat[3,2]<- -0.7718
ReArAgeEfMat[2,4]<- 0.2000
ReArAgeEfMat[4,2]<- 0.2000
ReArAgeEfMat[3,4]<- -0.5597
ReArAgeEfMat[4,3]<- -0.5597

chordDiagram(ReArAgeEfMat,grid.col = grid.col, col = col_fun,symmetric = "TRUE",annotationTrack=c("name","grid"),self.link = 1)
title(paste('PDM2 at K =',K))
