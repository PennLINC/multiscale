...
p5_5=read.csv('Y:/results/aggregated_data/BwSubj_p5_5_K4.csv')
# convert to matrix
...
#p5_10
p5_10=read.csv('Y:/results/aggregated_data/BwSubj_p5_10_K4.csv')
# convert to matrix
p5_10Mat=data.matrix(p5_10)

#p5_20
p5_20=read.csv('Y:/results/aggregated_data/BwSubj_p5_20_K4.csv')
# convert to matrix
...
```{r}
###### Sep. Plots - p5_5
windf<-data.frame(rep(c(p5_5win),400))
bwdf<-data.frame(c(p5_5bw))
colnames(windf)<-'Frequency'
colnames(bwdf)<-'Frequency'

ggplot(bwdf,aes(Frequency))+geom_histogram(fill='#7fcdbb')+geom_histogram(data=windf,aes(Frequency),fill='#2c7fb8')+scale_y_continuous(sec.axis=sec_axis(trans=~.*(1/400),name="Within-Subject Comparisons"))+theme_classic(base_size=40)+xlab('ARI: Spar = .5, Loc = 5')+ylab("Between-Subject Comparisons")+theme(axis.text.y.right = element_text(color="#2c7fb8"),axis.text.y.left = element_text(color="#7fcdbb"))+scale_x_continuous(breaks=c(0,.2,.4,.6,.8,1), lim = c(0,1.1))

### Sep. Plots - p5_10
windf<-data.frame(rep(c(p5_10win),400))
bwdf<-data.frame(c(p5_10bw))
colnames(windf)<-'Frequency'
colnames(bwdf)<-'Frequency'

ggplot(bwdf,aes(Frequency))+geom_histogram(fill='#7fcdbb')+geom_histogram(data=windf,aes(Frequency),fill='#2c7fb8')+scale_y_continuous(sec.axis=sec_axis(trans=~.*(1/400),name="Within-Subject Comparisons"))+theme_classic(base_size=40)+xlab('ARI: Spar = .5, Loc = 10')+ylab("Between-Subject Comparisons")+theme(axis.text.y.right = element_text(color="#2c7fb8"),axis.text.y.left = element_text(color="#7fcdbb"))+scale_x_continuous(breaks=c(0,.2,.4,.6,.8,1), lim = c(0,1.1))

### Sep. Plots - p5_20
windf<-data.frame(rep(c(p5_20win),400))
bwdf<-data.frame(c(p5_20bw))
colnames(windf)<-'Frequency'
colnames(bwdf)<-'Frequency'

ggplot(bwdf,aes(Frequency))+geom_histogram(fill='#7fcdbb')+geom_histogram(data=windf,aes(Frequency),fill='#2c7fb8')+scale_y_continuous(sec.axis=sec_axis(trans=~.*(1/400),name="Within-Subject Comparisons"))+theme_classic(base_size=40)+xlab('ARI: Spar = .5, Loc = 20')+ylab("Between-Subject Comparisons")+theme(axis.text.y.right = element_text(color="#2c7fb8"),axis.text.y.left = element_text(color="#7fcdbb"))+scale_x_continuous(breaks=c(0,.2,.4,.6,.8,1), lim = c(0,1.1))

### Sep. Plots - 1_5
windf<-data.frame(rep(c(o1_5win),400))
bwdf<-data.frame(c(o1_5bw))
colnames(windf)<-'Frequency'
colnames(bwdf)<-'Frequency'

ggplot(bwdf,aes(Frequency))+geom_histogram(fill='#7fcdbb')+geom_histogram(data=windf,aes(Frequency),fill='#2c7fb8')+scale_y_continuous(sec.axis=sec_axis(trans=~.*(1/400),name="Within-Subject Comparisons"))+theme_classic(base_size=40)+xlab('ARI: Spar = 1, Loc = 5')+ylab("Between-Subject Comparisons")+theme(axis.text.y.right = element_text(color="#2c7fb8"),axis.text.y.left = element_text(color="#7fcdbb"))+scale_x_continuous(breaks=c(0,.2,.4,.6,.8,1), lim = c(0,1.1))

### Sep. Plots - 1_20
windf<-data.frame(rep(c(o1_20win),400))
bwdf<-data.frame(c(o1_20bw))
colnames(windf)<-'Frequency'
colnames(bwdf)<-'Frequency'

ggplot(bwdf,aes(Frequency))+geom_histogram(fill='#7fcdbb')+geom_histogram(data=windf,aes(Frequency),fill='#2c7fb8')+scale_y_continuous(sec.axis=sec_axis(trans=~.*(1/400),name="Within-Subject Comparisons"))+theme_classic(base_size=40)+xlab('ARI: Spar = 1, Loc = 20')+ylab("Between-Subject Comparisons")+theme(axis.text.y.right = element_text(color="#2c7fb8"),axis.text.y.left = element_text(color="#7fcdbb"))+scale_x_continuous(breaks=c(0,.2,.4,.6,.8,1), lim = c(0,1.1))

### Sep. Plots - o2_5
windf<-data.frame(rep(c(o2_5win),400))
bwdf<-data.frame(c(o2_5bw))
colnames(windf)<-'Frequency'
colnames(bwdf)<-'Frequency'

ggplot(bwdf,aes(Frequency))+geom_histogram(fill='#7fcdbb')+geom_histogram(data=windf,aes(Frequency),fill='#2c7fb8')+scale_y_continuous(sec.axis=sec_axis(trans=~.*(1/400),name="Within-Subject Comparisons"))+theme_classic(base_size=40)+xlab('ARI: Spar = 2, Loc = 5')+ylab("Between-Subject Comparisons")+theme(axis.text.y.right = element_text(color="#2c7fb8"),axis.text.y.left = element_text(color="#7fcdbb"))+scale_x_continuous(breaks=c(0,.2,.4,.6,.8,1), lim = c(0,1.1))

### Sep. Plots - o2_10
windf<-data.frame(rep(c(o2_10win),400))
bwdf<-data.frame(c(o2_10bw))
colnames(windf)<-'Frequency'
colnames(bwdf)<-'Frequency'

ggplot(bwdf,aes(Frequency))+geom_histogram(fill='#7fcdbb')+geom_histogram(data=windf,aes(Frequency),fill='#2c7fb8')+scale_y_continuous(sec.axis=sec_axis(trans=~.*(1/400),name="Within-Subject Comparisons"))+theme_classic(base_size=40)+xlab('ARI: Spar = 2, Loc = 10')+ylab("Between-Subject Comparisons")+theme(axis.text.y.right = element_text(color="#2c7fb8"),axis.text.y.left = element_text(color="#7fcdbb"))+scale_x_continuous(breaks=c(0,.2,.4,.6,.8,1), lim = c(0,1.1))

### Sep. Plots - 2_20
windf<-data.frame(rep(c(o2_20win),400))
bwdf<-data.frame(c(o2_20bw))
colnames(windf)<-'Frequency'
colnames(bwdf)<-'Frequency'

ggplot(bwdf,aes(Frequency))+geom_histogram(fill='#7fcdbb')+geom_histogram(data=windf,aes(Frequency),fill='#2c7fb8')+scale_y_continuous(sec.axis=sec_axis(trans=~.*(1/400),name="Within-Subject Comparisons"))+theme_classic(base_size=40)+xlab('ARI: Spar = 2, Loc = 20')+ylab("Between-Subject Comparisons")+theme(axis.text.y.right = element_text(color="#2c7fb8"),axis.text.y.left = element_text(color="#7fcdbb"))+scale_x_continuous(breaks=c(0,.2,.4,.6,.8,1), lim = c(0,1.1))
...
#p5_5 - p is for "point" (.5)
p5_5=read.csv('Y:/results/aggregated_data/BwSubj_p5_5_K20.csv')
# convert to matrix
p5_5Mat=data.matrix(p5_5)
# get index of upper triangle
UTI=upper.tri(p5_5Mat)
...
#p5_10
p5_10=read.csv('Y:/results/aggregated_data/BwSubj_p5_10_K20.csv')
# convert to matrix
p5_10Mat=data.matrix(p5_10)

#p5_20
p5_20=read.csv('Y:/results/aggregated_data/BwSubj_p5_20_K20.csv')
# convert to matrix
p5_20Mat=data.matrix(p5_20)
...
ggplot(bwdf,aes(Frequency))+geom_histogram(fill='#7fcdbb')+geom_histogram(data=windf,aes(Frequency),fill='#2c7fb8',bins=)+scale_y_continuous(sec.axis=sec_axis(trans=~.*(1/400),name="Within-Subject Comparisons"))+theme_classic(base_size=40)+xlab('ARI: Spar = 2, Loc = 20')+ylab("Between-Subject Comparisons")+theme(axis.text.y.right = element_text(color="#2c7fb8"),axis.text.y.left = element_text(color="#7fcdbb"))+scale_x_continuous(breaks=c(0,.2,.4,.6,.8,1), lim = c(0,1.1))
