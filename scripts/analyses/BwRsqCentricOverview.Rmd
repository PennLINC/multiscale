...
ggplot(long_affilsUnique,
  ...
  theme(legend.position = "none") +
  ggtitle("Community Emergence over Scales")+
  scale_fill_manual(values=c('#007500','#c1253c','#d77d00','#b8cf86','#3281ab','#b61ad0','#670068'))
  #scale_fill_manual(values=c('#dc8303','#8d2049','#596a85','#2d9a3d','#007938','#d9e200','#bc0943','#2b1f67','#48593a','#91a967','#4183a8','#00bb89','#3245a3','#9e3ca2','#eb75b3','#68126f','#d1001c'))+theme_classic()


# organize by transmodality for community number
```
