...
prepDataFile = ['/cbica/home/pinesa/multiscale/results/sge/CreatePrepData.mat'];
...
for i = 1:50
  ...
  Prev_resfp = [Prev_init_fold '/InitializationRes_' num2str(i) '/Initialization_num100_comp' num2str(K) '_S1_' num2str(pS) '_L_' num2str(pL) '_spaR_1_vxInfo_1_ard_0/init.mat'];
  if ~exist(Prev_resfp, 'file')
