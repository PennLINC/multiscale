...
#### repeated ggpplot uses residuals, NOT SIMULTANEOUSLY FITTED AGE COEFFICIENT AT THE MOMENT ### 
...
### plot mean global seg over scales by age
# 2:30 is ind, 5455:5483 is group
indglobseg<-cbind(masterdf$bblid,masterdf$F1_Exec_Comp_Cog_Accuracy,masterdf$Sex,masterdf$Motion,masterdf[,2:30])
groglobseg<-cbind(masterdf$bblid,masterdf$F1_Exec_Comp_Cog_Accuracy,masterdf$Sex,masterdf$Motion,masterdf[,5455:5483])
