...
indglobseg<-cbind(masterdf$bblid,masterdf$ageAtScan1/12,masterdf$sex,masterdf$Motion,masterdf$F1_Exec_Comp_Cog_Accuracy.x,masterdf[,2:30])
groglobseg<-cbind(masterdf$bblid,masterdf$ageAtScan1/12,masterdf$sex,masterdf$Motion,masterdf$F1_Exec_Comp_Cog_Accuracy.x,masterdf[,5455:5483])
