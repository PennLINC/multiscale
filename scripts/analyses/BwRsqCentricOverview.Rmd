...
FullnonlinModEF=gamm(AvgBetweenCon~s(Scale,k=3,fx=T)+s(Transmodality,k=3,fx=T)+s(Age,k=3,fx=T)+ti(Scale,Age,k=3,fx=T)+ti(Age,Transmodality,k=3,fx=T)+ti(Age,Transmodality,Scale,k=3,fx=T)+ti(Scale,EF,k=3,fx=T)+ti(EF,Transmodality,k=3,fx=T)+ti(EF,Scale,Transmodality,k=3,fx=T)+Sex+Motion+EF,random=list(bblid=~1),data=Melted_clevel_ef)
PartialnonlinModEF=gamm(AvgBetweenCon~s(Scale,k=3,fx=T)+s(Transmodality,k=3,fx=T)+s(Age,k=3,fx=T)+ti(Scale,EF,k=3,fx=T)+ti(EF,Transmodality,k=3,fx=T)+ti(EF,Scale,Transmodality,k=3,fx=T)+Sex+Motion+EF,random=list(bblid=~1),data=Melted_clevel_ef)
# more sophisticated version
SophMod<-gamm(AvgBetweenCon~ti(Age,Scale,k=3)+Sex+Motion, random=list(bblid=~1),data=Melted_clevel_ef,REML=T)
