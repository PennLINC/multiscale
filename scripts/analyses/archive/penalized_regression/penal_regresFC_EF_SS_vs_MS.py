...
### note that residuals of age~motion were better predicted by multiscale aggregation: led to .525 r^2
...
for scale in range(2,32):
	...
	filename='/cbica/projects/pinesParcels/results/EffectVecs/edgesAt' + str(scale) + '_EF'
