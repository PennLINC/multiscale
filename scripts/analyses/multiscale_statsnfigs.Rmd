...
LongAgeSpan_plotdf3$Age<-NetSplinesAgeSideCar693464

LongAgeSpan_plotdf3$Splines<-((LongAgeSpan_plotdf3$Splines*sd(masterdf$Age)+mean(masterdf$Age)))




ggplot(LongAgeSpan_plotdf3,aes(Age,Splines,color=Transmodality,group=Grouping)) +geom_line(size=1,alpha=.1) +labs(title='Network Segregation Effect Manifestation', x = 'Age', y = 'Predicted Segregation') +theme_classic(base_size = 28)+ xlim(c(8,23))
